...
export const CHILE_REGIONS: Region[] = [
  ...
  },
  {
    ...
    communes: [
      ...
      "Colina", "Lampa", "Tiltil", "San Bernardo", "Buin", "Calera de Tango", "Paine", "Melipilla",
  ...
  },
  {
    ...
    communes: [
      ...
      "San Clemente", "San Rafael", "Curicó", "Hualañé", "Licantén", "Molina", "Romeral",
      "Sagrada Familia", "Teno", "Vichuquén", "Linares", "Colbún", "Longaví", "Parral", "Retiro",
      "San Javier", "Villa Alegre", "Yerbas Buenas", "Cauquenes", "Chanco", "Pelluhue"
    ]
  },
  {
  ...
  },
  {
    ...
    communes: [
      ...
      "Laja", "Mulchén", "Nacimiento", "Negrete", "Quilaco", "Quilleco", "San Rosendo", "Santa Bárbara",
